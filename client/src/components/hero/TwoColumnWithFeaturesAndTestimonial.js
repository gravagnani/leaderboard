...
const Image = tw.img`max-w-full md:w-auto lg:w-96 rounded-t sm:rounded relative z-20`;
...
export default ({
	...
	features = [
		"Up to 100 players",
		"Classic and TrueSkill scoring calculations",
		"Free for basic competitions",
	],
	testimonial = {
		quote:
