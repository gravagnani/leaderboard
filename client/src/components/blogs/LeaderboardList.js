...
const PopularPostsContainer = tw.div`lg:w-2/3 pr-10`;
...
const Table = tw.table`min-w-full divide-y divide-gray-200 mt-20 mr-20`;
				...
				<Row>
					<PopularPostsContainer>
						...
						<Table>
							<TableHead>
								<TableRow>
									<TableHeadItem>Position</TableHeadItem>
							...
							<TableBody>
								<TableRow>
									...
									<TableRowItem>Ivo</TableRowItem>
									<TableRowItem>123</TableRowItem>
									<TableRowItem>Edit</TableRowItem>
								</TableRow>
								<TableRow>
									<TableRowItem>2</TableRowItem>
									<TableRowItem>Gilda</TableRowItem>
									<TableRowItem>78</TableRowItem>
									<TableRowItem>Edit</TableRowItem>
								</TableRow>
								<TableRow>
									<TableRowItem>3</TableRowItem>
									<TableRowItem>Ciccio</TableRowItem>
									<TableRowItem>54</TableRowItem>
									<TableRowItem>Edit</TableRowItem>
								</TableRow>
								<TableRow>
									<TableRowItem>4</TableRowItem>
									<TableRowItem>Beppe</TableRowItem>
									<TableRowItem>21</TableRowItem>
									<TableRowItem>Edit</TableRowItem>
								</TableRow>
							</TableBody>
						</Table>
